...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\PycharmProjects\AuthenticationAndPasswordManagement\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\PycharmProjects\AuthenticationAndPasswordManagement\venv\Scripts\deactivate.nu'
